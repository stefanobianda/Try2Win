...
import 'package:try2win/qrcode/scanner_error_widget.dart';

class BarcodeScannerWithOverlay extends StatefulWidget {
  const BarcodeScannerWithOverlay({super.key, required this.setResult});

  final void Function(String result) setResult;

  @override
  State<BarcodeScannerWithOverlay> createState() {
    return _BarcodeScannerWithOverlayState();
  }
}
